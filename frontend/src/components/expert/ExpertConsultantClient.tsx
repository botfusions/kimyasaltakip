    ...
    <div className="flex flex-col h-[calc(100vh-12rem)] max-w-5xl mx-auto bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-200 dark:border-gray-700">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/50 flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-gray-900 dark:text-white">
              Uluslararası Boya ve Kimya Uzmanı
            </h2>
            <div className="flex items-center gap-1.5">
              <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
              <span className="text-xs text-gray-500 dark:text-gray-400 font-medium">
                Teknik Danışman Çevrimiçi
              </span>
            </div>
          </div>
        </div>
        <Button
          ...
          className="text-gray-500 hover:text-red-500 border-none bg-transparent"
        >
      ...
      {messages.length === 0 && (
        <div className="m-4 p-4 bg-blue-50 dark:bg-blue-900/10 border border-blue-100 dark:border-blue-800 rounded-xl flex gap-3">
          ...
          <p className="text-sm text-blue-800 dark:text-blue-200">
            <strong>Nasıl yardımcı olabilirim?</strong> Boyama süreçleri,
            kimyasal haslıklar (ISO 105), pH kontrolü veya iplik türlerine özel
            boya reçeteleri hakkında teknik sorularınızı sorabilirsiniz.
          </p>
        </div>
      )}
      ...
      <div className="p-4 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700">
        ...
        <p className="text-[10px] text-center text-gray-400 mt-2 flex items-center justify-center gap-1">
          ...
          Yapay zeka teknik hatalar yapabilir. Önemli kararlar için her zaman
          laboratuvar testlerini referans alınız.
        </p>
      </div>
    </div>
  );
