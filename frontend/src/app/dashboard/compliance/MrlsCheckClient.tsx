...
import { checkRecipeCompliance } from "../../actions/compliance";
import {
  AlertCircle,
  CheckCircle,
  FileText,
          ...
          <div className="max-h-60 overflow-y-auto border rounded-lg dark:border-gray-600">
            {filteredRecipes.map((recipe) => (
              <div
                ...
                className={`p-3 cursor-pointer border-b last:border-0 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors ${
