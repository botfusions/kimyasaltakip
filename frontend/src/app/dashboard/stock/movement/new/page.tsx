            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="bg-white rounded-lg shadow">
                    <div className="px-6 py-4 border-b border-gray-200">
                        <h2 className="text-lg font-semibold text-gray-900">Hareket Detayları</h2>
                    ...
                    <div className="p-6">
                        <StockMovementForm materials={activeMaterials} currentUser={currentUser} />
                    </div>
                </div>

                {/* Help Section */}
                <div className="mt-6 bg-white rounded-lg shadow p-6">
                    <h3 className="text-sm font-medium text-gray-900 mb-3">❓ Sık Sorulan Sorular</h3>
                    <div className="space-y-3 text-sm text-gray-700">
                        <details className="group">
                            ...
                            <p className="mt-2 pl-4 text-gray-600">
                                <strong>Giriş:</strong> Yeni malzeme satın alındığında veya depoya girdiğinde kullanılır. Stok miktarını artırır.<br />
                                <strong>Çıkış:</strong> Malzeme üretimde kullanıldığında, satıldığında veya tüketildiğinde kullanılır. Stok miktarını azaltır.
                            </p>
                        </details>
                        ...
                        <details className="group">
                            ...
                            <p className="mt-2 pl-4 text-gray-600">
                                Sayım sonrası fark bulunduğunda veya sistemdeki stok miktarı gerçek stok miktarından farklı olduğunda kullanılır.
                                Girdiğiniz miktar yeni toplam stok miktarı olacaktır.
                            </p>
                        </details>
                        ...
                        <details className="group">
                            ...
                            <p className="mt-2 pl-4 text-gray-600">
                                Hayır, opsiyoneldir. Ancak maliyet takibi ve raporlama için önerilir. Özellikle giriş hareketlerinde
                                birim maliyeti girmek, ortalama maliyet hesaplamalarına yardımcı olur.
                            </p>
                        </details>
                        ...
                        <details className="group">
                            ...
                            <p className="mt-2 pl-4 text-gray-600">
                                Tedarikçiden gelen malzemelerin lot/batch numarasıdır. Kalite kontrolü ve izlenebilirlik için
                                önemlidir. Opsiyoneldir ancak özellikle kimyasal maddelerde önerilir.
                            </p>
                        </details>
                    </div>
                </div>
